...
class FourierUnit_modified(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, image_size, groups=1, spatial_scale_factor=None, spatial_scale_mode='bilinear',
                 spectral_pos_encoding=False, use_se=False, ffc3d=False, fft_norm='ortho'):
        # bn_layer not used
        super(FourierUnit_modified, self).__init__()
        self.groups = groups

        self.input_shape = image_size  # change!!!!!it!!!!!!manually!!!!!!
...
class CViT(nn.Module):
    def __init__(self, image_size=224, patch_size=7, num_classes=2, channels=512,
        ...
        self.uffc = FourierUnit_modified(in_channels=256, out_channels=256, image_size=14)
