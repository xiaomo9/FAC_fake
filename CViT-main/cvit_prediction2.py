...
frames = 100
# 待预测的视频文件夹
sample = r"E:\Daima\dataset\DFDC\video\test"
# 标签文件
# metafile = r"E:\Daima\dataset\prediction_data\prediction_data\metadata.json"
# 预测结果.csv保存位置  `


save_csv_path = "./wprediction/cvit_dfdc_FF_test_dfdc.csv"
...
checkpoint = torch.load(r'E:\Daima\face_fake\CViT-main\weight\cvit_dfdc_FFtotal.pth', map_location=torch.device('cuda'))
...
if __name__ == '__main__':
    ...
    #     return correct,lens
    #
    # correct_num,lens = real_or_fake(filenames,predictions)
    # print("correct_num:{}   lens:{}".format(correct_num,lens))
    # print('Accuracy: ', correct_num/lens*100)
    #-----------------------------------------------------------------------------
